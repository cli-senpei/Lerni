...
-- Create trigger for games updated_at if not exists
...
-- Insert default games only if table is empty
INSERT INTO public.games (name, description, component_name, display_order, difficulty_level)
SELECT * FROM (VALUES
...
) AS v(name, description, component_name, display_order, difficulty_level)
